    ...
    <div className="min-h-screen bg-[#0B0F19] text-slate-300 p-6 font-sans">
      ...
      <div className="max-w-5xl mx-auto bg-slate-900/40 border border-slate-800/80 rounded-2xl p-6 md:p-8 mb-8 shadow-zipGlow">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div>
            <span className="text-sm font-mono uppercase bg-blue-600/10 text-blue-400 border border-blue-500/20 px-2.5 py-1 rounded">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-800/80 rounded-xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/" className="px-3 py-1.5 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 font-mono text-sm rounded border border-blue-500/30 transition-colors">
                ← Back to Core Hub
              </Link>
            </div>
          </div>
