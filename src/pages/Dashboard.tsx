          ...
          <div className="space-y-3">
            {savedCodes.map((item) => (
              <div key={item.id} className="p-3 bg-slate-950 border border-slate-800/80 rounded-lg flex items-center justify-between hover:border-slate-700 transition-colors">
                <div>
                  <span className="text-sm font-mono font-bold bg-slate-800 text-slate-300 px-1.5 py-0.5 rounded mr-2 uppercase">
                    {item.country}
                  </span>
        ...
        <div className="p-5 bg-slate-900/40 border border-slate-800 rounded-xl">
          ...
          <div className="space-y-3">
            {recentActivity.map((log) => (
              <div key={log.id} className="p-3 bg-slate-950 border border-slate-800/80 rounded-lg flex items-center justify-between text-sm">
