          ...
          >
            <div className="p-8 lg:p-10 space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  <label className="text-sm font-black text-slate-100 uppercase tracking-widest mb-3 block italic">{t('pasteMessyAddress')}</label>
                  <textarea
                    value={address}
                    onChange={(e) => setAddress(e.target.value)}
                    placeholder="e.g. 1600 ampitheatre pkwy, mountain view, ca, 94043..."
                    className="w-full h-32 bg-slate-900/40 border border-slate-800 rounded-2xl p-4 text-slate-200 placeholder:text-slate-200 focus:outline-none focus:border-gold/50 focus:bg-slate-900/60 transition-all font-medium text-base resize-none"
                  />
                </div>
            ...
            <div className="p-8 lg:p-10 space-y-8">
              ...
              <form onSubmit={handleCalculateDistance} className="space-y-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-black text-slate-100 uppercase tracking-widest mb-3 block italic">{t('source')}</label>
                    <input
                      value={distSource}
                      onChange={(e) => setDistSource(e.target.value)}
                      placeholder="e.g. 531077 or Hukumpeta"
                      className="w-full bg-slate-900/40 border border-slate-800 rounded-2xl p-4 text-slate-200 placeholder:text-slate-200 focus:outline-none focus:border-gold/50 focus:bg-slate-900/60 transition-all font-medium text-base"
                    />
                  </div>
                  <div>
                    <label className="text-sm font-black text-slate-100 uppercase tracking-widest mb-3 block italic">{t('destination')}</label>
                    <input
                      value={distDest}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div className="p-8 lg:p-10 space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  <label className="text-sm font-black text-slate-100 uppercase tracking-widest mb-3 block italic">{t('areaNameOrZip')}</label>
                  <input
                    type="text"
                    value={postalQuery}
                    onChange={(e) => setPostalQuery(e.target.value)}
                    placeholder="e.g. 531077 or Beverly Hills"
                    className="w-full bg-slate-900/40 border border-slate-800 rounded-2xl p-4 text-slate-200 placeholder:text-slate-200 focus:outline-none focus:border-gold/50 focus:bg-slate-900/60 transition-all font-medium text-base shadow-inner"
                  />
                </div>
