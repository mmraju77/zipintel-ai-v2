    ...
    <footer className="w-full mt-16 bg-[#070a12] border-t border-slate-800/80 text-slate-400 py-10 px-6 font-sans">
      ...
      <div className="max-w-6xl mx-auto mb-8 p-4 bg-slate-900/30 border border-slate-800/50 rounded-xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 text-xs font-mono leading-relaxed text-slate-400 italic">
          ...
          <p>
            <strong className="text-slate-400 uppercase">Jurisdictional Notice:</strong> This software operates under the digital services frameworks of India (IT Act 2000), the European Union (GDPR), and the United States (Electronic Communications Privacy Act). All routing matrices are provided "as-is" for informational purposes. Local jurisdictional restrictions may apply to specific ledger node queries.
          </p>
        </div>
      </div>
