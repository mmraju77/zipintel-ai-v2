    ...
    <div className="glass-card p-8 flex flex-col justify-center space-y-6">
      ...
      <form onSubmit={onCalculate} className="space-y-4">
        ...
        <button
          ...
          className="w-full h-14 bg-gold hover:bg-gold/80 hover:scale-[1.02] active:scale-[0.98] text-midnight rounded-2xl font-black text-sm uppercase tracking-[0.4em] transition-all flex items-center justify-center gap-3 group disabled:opacity-50 shadow-[0_10px_30px_rgba(212,175,55,0.2)]"
        >
          {distLoading ? (
