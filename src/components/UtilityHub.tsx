        ...
        {activeTab === 'json' && (
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-40 p-3 bg-slate-950 border border-slate-800 rounded-lg text-white font-mono text-sm focus:outline-none focus:border-blue-500 resize-none"
                />
              </div>
              <div>
            ...
            <button
              ...
              className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-mono text-sm uppercase tracking-wider font-bold rounded-lg transition-colors"
            >
              Parse & Format Lint
            </button>
          </div>
        ...
        {activeTab === 'csv' && (
          <div className="space-y-3 animate-fade-in">
            ...
            <textarea
              ...
              className="w-full h-24 p-3 bg-slate-950 border border-slate-800 rounded-lg text-white font-mono text-sm focus:outline-none focus:border-blue-500"
            />
            {renderCsvTable()}
          </div>
        )}
